...
const game = (choice) => {
    ...
    function getPic(userChoice, computerChoice) {
        ...
        if (userChoice === "r") {
            userPick.innerHTML = `<img src="/docs/images/rock.png" loading="lazy" style="margin-top: 0.5rem; height: 100px; width: 100px;">`
        } else if (userChoice === "p") {
            userPick.innerHTML = `<img src="/docs/images/paper.png" loading="lazy" style="margin-top: 0.25rem; height: 100px; width: 100px;">`
        } else {
           userPick.innerHTML = `<img src="/docs/images/scissors.png" loading="lazy" style="margin-top: 0.5rem; height: 100px; width: 100px;">`
        }
        setTimeout(() => {
            if (computerChoice === "r") {
                compPick.innerHTML = `<img src="/docs/images/rock.png" loading="lazy" style=" margin-top: 0.5rem; height: 100px; width: 100px;">`
            } else if (computerChoice === "p") {
                compPick.innerHTML = `<img src="/docs/images/paper.png" loading="lazy" style=" margin-top: 0.25rem; height: 100px; width: 100px;">`
            } else {
                compPick.innerHTML = `<img src="/docs/images/scissors.png" loading="lazy" style=" margin-top: 0.5rem; height: 100px; width: 100px;">`
            }
        }, 2100);
    }
